...
//		if (content.contains("cell(") || content.equals("clear")) {
//	        // Trasformiamo il dispatch della pagina in una request sincrona verso l'attore
//	        answerToReadRequest(m);
//	    } else {
...
//		String content = m.msgContent();
//		if (content.contains("cell(") || content.equals("clear")) {
//			String replyTopic = "answ_" + m.msgId() + "_" + m.msgSender();
//			mqttsupport.publish(replyTopic, m.toString(), 1, false);
//	    }
//		else{	
